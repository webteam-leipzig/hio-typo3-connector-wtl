...
(static function (): void {
    ...
    $GLOBALS['TCA']['tt_content']['palettes']['tx_hiotypo3connectorwtl_featured_project'] = [
        ...
        'showitem' => '
            image,
            --linebreak--,
            tx_hiotypo3connectorwtl_featured_project,
        ',
    ];
    ...
    $GLOBALS['TCA']['tt_content']['types']['tx_hiotypo3connectorwtl_featured_project'] = [
        'showitem' => '
            --div--;LLL:EXT:core/Resources/Private/Language/Form/locallang_tabs.xlf:general,
                --palette--;;general,
                --palette--;;tx_hiotypo3connectorwtl_featured_project,
