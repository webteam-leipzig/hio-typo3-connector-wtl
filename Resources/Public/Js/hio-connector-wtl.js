(() => {
  ...
  // js/controllers/SwiperController.js
  var SwiperController_exports = {};
  __export(SwiperController_exports, {
    default: () => SwiperController
  });
  var SwiperController;
  var init_SwiperController = __esm({
    "js/controllers/SwiperController.js"() {
      init_swiper();
      init_modules();
      SwiperController = class {
        ...
        getSwiperOptions(swiperElement, uniqueId) {
          ...
          const breakpoints2 = this.breakPointsConfig();
  ...
  // js/index.js
  var controllerMap = {
    SwiperController: () => Promise.resolve().then(() => (init_SwiperController(), SwiperController_exports))
  };
  var controllerCache = {};
  function initializeController(controllerClass) {
    ...
    if (loader) {
      loader().then(({ default: Controller2 }) => {
        if (Controller2) {
          try {
            controllerCache[controllerClass] = new Controller2();
          } catch (error) {
